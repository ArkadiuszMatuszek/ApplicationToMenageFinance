<?php
	...
	$nowa_data1 = "20"."$year"."-"."01"."-"."01";
	$nowa_data2 = "20"."$year"."-"."12"."-"."31";	
	...
	<article>
		<div id="wybieranieDaty">
				...
				<select name="data" onchange="location = this.value;">
					...
					<option value="PrzegladajBilansBiezacyRok.php" selected>Bieżacy rok</option>
...
<div class="AktualniePrzegladaneDaty">
	Aktualnie przeglądany jest bilans całego roku <br />
