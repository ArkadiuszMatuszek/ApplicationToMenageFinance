<?php
	...
	$pierwszy_dzien = $month-$month+1;
	$poprzedni_miesiac = $month-1; 
	$ostatni_dzien = date("t", mktime (0,0,0,date("m")-1,date("d"),  date("Y")));; 
	
	$nowa_data1 = "20"."$year"."-"."$poprzedni_miesiac"."-"."0"."$pierwszy_dzien";
	$nowa_data2 = "20"."$year"."-"."$poprzedni_miesiac"."-"."$ostatni_dzien";
	...
	<article>
		<div id="wybieranieDaty">
				...
				<select name="data" onchange="location = this.value;">
					...
					<option value="PrzegladajBilansPoprzedniMiesiac.php" selected>Poprzedni miesiąc</option>
...
<div class="tabele">
	...
	Aktualnie przeglądany jest bilans z poprzedniego miesiąca <br />
